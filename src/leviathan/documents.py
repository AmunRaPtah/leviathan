...
CHUNK_WORDS = int(os.environ.get("LEVIATHAN_CHUNK_WORDS", "220"))      # target words/chunk
CHUNK_OVERLAP = int(os.environ.get("LEVIATHAN_CHUNK_OVERLAP", "40"))   # words shared between chunks
CHUNK_SENTENCE_AWARE = os.environ.get("LEVIATHAN_CHUNK_SENTENCE_AWARE", "1") != "0"
