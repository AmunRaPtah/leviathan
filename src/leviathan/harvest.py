    ...
    with obs.span("harvest", limit=limit):
        ...
        if build:
            ...
            try:
                ...
                embeddings.build_index(con, backend=os.environ.get("LEVIATHAN_EMBED_BACKEND", "auto"),
                                       model=os.environ.get("LEVIATHAN_EMBED_MODEL", "all-MiniLM-L6-v2"))
