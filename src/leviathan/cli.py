"""Command-line entrypoint: `python -m leviathan <command>`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="leviathan", description=__doc__)
    ...
    rp.add_argument("--to", default=None, help="recipient (default LEVIATHAN_EMAIL_TO)")
